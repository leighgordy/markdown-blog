...
describe("Test generate-post-pages.ts", async () => {
  ...
  beforeEach(async () => {
    ...
    copyFolderContentsMock.mock.mockImplementation(() => Promise.resolve() as any);
    createPostPageMock.mock.mockImplementation(() => "<html>Page</html>" as any);
  ...
  test("Ensure post template is read once", async () => {
    const posts: PostInfo[] = [
      { name: "Post 1", fileName: "post1", creationDate: new Date("2023-01-01"), blogDirectory: "./dist/blog/2023-1-1-0-0-0", dateDirectory: "2023-1-1-0-0-0", directory: "1672531200000_post1", blogPage: "./dist/blog/2023-1-1-0-0-0/post1.html", blogUrl: "/posts/2023-1-1-0-0-0/post1.html" },
      { name: "Post 2", fileName: "post2", creationDate: new Date("2023-01-02"), blogDirectory: "./dist/blog/2023-1-2-0-0-0", dateDirectory: "2023-1-2-0-0-0", directory: "1672617600000_post2", blogPage: "./dist/blog/2023-1-2-0-0-0/post2.html", blogUrl: "/posts/2023-1-2-0-0-0/post2.html" },
    ];
    ...
    assert.strictEqual(readFileMock.mock.calls[0].arguments[0], "./src/blog/post/post.html");
  });
  ...
  test("Ensure directories are created for each post", async () => {
    ...
    assert.strictEqual(createDirMock.mock.calls[0].arguments[0], "./dist/blog/2023-1-1-0-0-0");
  });
  ...
  test("Ensure post pages are created for each post", async () => {
    ...
    assert.strictEqual(createFileMock.mock.calls[0].arguments[0], "./dist/blog/2023-1-1-0-0-0/post1.html");
  });
  ...
  test("Ensure folder contents are copied and content.md is deleted", async () => {
    ...
    assert.strictEqual(copyFolderContentsMock.mock.calls[0].arguments[0], "./src/blog/post/1672531200000_post1");
    assert.strictEqual(copyFolderContentsMock.mock.calls[0].arguments[1], "./dist/blog/2023-1-1-0-0-0");

    assert.strictEqual(deleteFileMock.mock.callCount(), 1);
    assert.strictEqual(deleteFileMock.mock.calls[0].arguments[0], "./dist/blog/2023-1-1-0-0-0/content.md");
  });
});